...
<div align="center">
  <img src="/app/assets/images/playlstr-logo.png" alt="playlstr logo" width="400px" height="150px"/>
  <br>
  <i>Playlstr is a web application for viewing user curated playlists! Anyone can register an account and create their own playlists. Using the Spotify API a user has access to thousands of tracks! You don't even need to connect your Spotify account.</i>
</div>
